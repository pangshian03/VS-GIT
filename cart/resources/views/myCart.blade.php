...
function cal() {
    ...
    for (var i = 0; i < len; i++) {
        if (cboxes[i].checked) { //calculated if checked
                ...
                <table class="table table-bordered">
                    ...
                    <form action="{{ route('payment.post') }}" method="post" class="require-validation"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" name="cid[]" id="cid[]" value="{{$cart->cid}}"
                                        onclick="cal()">
                                    <input type="hidden" name="subtotal[]" id="subtotal[]"
                                        value="{{$cart->price*$cart->cartQty}}">
                                </td>
                                <td width="10%">
                                    <img src="{{asset('images/')}}/{{$cart->image}}" width="100" alt=""
                                        class="img-fluid">
                                </td>
                                <td>{{$cart->name}}</td>
                                <td>{{$cart->price}}</td>
                                ...
                                <td>
                                    <a href="{{route('delete.Item',['id'=>$cart->id])}}" class="delete" title="Delete"
                                        data-toggle="tooltip">
